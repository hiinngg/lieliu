layui.define(['element'], function (exports) {
     ...
     * [参数设置 options]
     */
    LarryTab.prototype.set = function (options) {   //初始设置
        var _this = this;
     ...
     */
    LarryTab.prototype.init = function () {           //初始化tab组件（根据config）
        var _this = this;
     ...
     * @return {[type]}      [description]
     */
    LarryTab.prototype.tabAdd = function (data) {   //data:href 、title
        var _this = this;
        ...
        if (tabIndex === -1) {     //要新增
           ...
           /* if (data.icon !== undefined) {
            ...
            //切换到当前打开的选项卡
            //ELEM.titleBox.find('li').length - 1
            element.tabChange(ELEM.tabFilter, idt);
        } else {
