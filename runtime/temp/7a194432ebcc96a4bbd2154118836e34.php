<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\wamp3\wamp64\www\lieliu\public/../application/admin\view\question\edit.html";i:1525773436;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body style="overflow:scroll;">
 ...
 <div class="layui-form-item layui-form-text">
    <div class="layui-input-block" style="margin-left:130px;">
      <p style="text-align:center;margin:15px;">问题</p>
 ...
 <div class="layui-form-item layui-form-text">
    <div class="layui-input-block"  style="margin-left:130px;">
    <p style="text-align:center;margin:15px;">回答</p>
