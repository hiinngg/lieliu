<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"D:\wamp3\wamp64\www\lieliu\public/../application/admin\view\usertask\index.html";i:1525763896;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<!-- 	<blockquote class="layui-elem-quote flex-row">
	...
	var tranStatus={
		...
		var articleTable = table.render({
			        ...
			        cols:[[
			         {checkbox: true},
			         {field: 'taskid', title: '编号',type:"numbers" },
			         {field: 'third_task_id', title: '猎流订单号' },
			         {field: 'tel', title: '创建人手机号' },
